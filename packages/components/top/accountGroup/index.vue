<template>
  ...
  <div class="lc-common-toolbar toolbar"
    ...
    <div class="left" style="font-weight: bold;"><lc-icon icon="mdiAccountSupervisor" style="margin-right: 4px" size="large" />
    {{ $t('_.components.top.accountGroup.title') }}
    </div>
    ...
    <el-table-column :label="$t('_._.operation')" width="320">
      <template #default="sp">
        <el-button-group>
          ...
          <el-button @click="handleCopy(sp)"  v-auth:accountGroup_add>{{ $t('_._.copy') }}</el-button>
