<template>
    <el-dialog v-model="dialogVisible" :title="$t('_.components.top.accountRole.dialogTitle')" :destroy-on-close="true"
        :close-on-click-modal="false" :close-on-press-escape="false" width="65%">
        ...
        <el-form ref="dataEditorFormRef" :model="formData" label-width="120px">
            ...
            <el-form-item :label="$t('_.components.top.accountRole.authorities')" prop="authorities">
